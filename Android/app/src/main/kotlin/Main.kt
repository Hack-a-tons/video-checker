...
internal val logger: SkipLogger = SkipLogger(subsystem = "video.checker", category = "VideoChecker")

private typealias AppRootView = VideoCheckerRootView
private typealias AppDelegate = VideoCheckerAppDelegate
